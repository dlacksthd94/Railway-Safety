...
python main.py --c_api Google --c_model gemini-2.5-flash --c_n_generate 4 --c_json_source img --c_seed 1 --r_question_batch all --r_api Huggingface --r_model microsoft/phi-4